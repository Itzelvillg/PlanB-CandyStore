...
class Clientes implements CRUD{
    ...
    public function update(){
        ...
        $stmt = $conn->prepare("UPDATE clientes SET nombre=:nombre,apellido=:apellido,direccion=:direccion,telefono=:telefono,foto=:foto, email=:email, pass=:pass WHERE id=:id");
