        ...
        case 1: //create
            if(isset($_REQUEST['id']) && isset($_REQUEST['nombre']) && isset($_REQUEST['apellido']) && isset($_REQUEST['direccion']) && isset($_REQUEST['telefono']) && isset($_FILES['foto']) &&  isset($_REQUEST['email']) && isset($_REQUEST['pass'])){
                ...
                if($resultado == 1){
                   ...
                   header("Location: ../../frontend/vistas/privado/clientes/admin/index.php?estatus=registrado");

                }else{
                   header("Location: ../../frontend/vistas/privado/clientes/admin/index.php?estatus=No_registrado");
            ...
            if((isset($_REQUEST['id']) && isset($_REQUEST['nombre']) && isset($_REQUEST['apellido'])
             && isset($_REQUEST['direccion']) && isset($_REQUEST['telefono'])  &&  isset($_REQUEST['email']) && isset($_REQUEST['pass'])) || isset($_FILES['foto'])){
                ...
                if($resultado==1){
                    ...
                    header("Location: ../../frontend/vistas/privado/clientes/admin/index.php?estatus=actualizado");
                }
            }else{
                header("Location: ../../frontend/vistas/privado/clientes/admin/index.php?estatus=No_actualizado");
                }  
              break;
        ...
        case 3: //delete
            ...
            if (isset($_REQUEST['id'])) {
                ...
                if($resultado == 1){
                    ...
                    header("Location: ../../frontend/vistas/privado/clientes/admin/index.php?estatus=borrado");
                }else{
                   // header("Location: ../../frontend/vistas/clientes/index.php?estatus=NoBorrado");
                   header("Location: ../../frontend/vistas/privado/clientes/admin/index.php?estatus=No_borrado");
