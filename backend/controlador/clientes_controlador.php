            ...
            if((isset($_REQUEST['id']) && isset($_REQUEST['nombre']) && isset($_REQUEST['apellido'])
             && isset($_REQUEST['direccion']) && isset($_REQUEST['telefono'])  &&  isset($_REQUEST['email']) && isset($_REQUEST['pass'])) || isset($_FILES['foto'])){
                ...
                if($resultado==1){
                    ...
                    header("Location: ../../frontend/vistas/privado/clientes/index_trabajador.php?estatus=actualizado");
                }
            }else{
                header("Location: ../../frontend/vistas/privado/clientes/index_trabajador.php?estatus=No_actualizado");
                }  
              break;
