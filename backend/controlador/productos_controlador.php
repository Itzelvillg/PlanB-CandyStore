        ...
        case 1: //create
            if(isset($_REQUEST['id']) && isset($_REQUEST['nombre']) && isset($_REQUEST['precio']) && isset($_FILES['foto']) &&  isset($_REQUEST['descripcion']) && isset($_REQUEST['estatus'])){
                ...
                if($resultado == 1){
                   ...
                   header("Location: ../../frontend/vistas/privado/productos/index_trabajador.php?estatus=registrado");

                }else{
                   header("Location: ../../frontend/vistas/privado/productos/index_trabajador.php?estatus=No_registrado");
            ...
            if((isset($_REQUEST['id']) && isset($_REQUEST['nombre']) && isset($_REQUEST['precio'])
               &&  isset($_REQUEST['descripcion']) && isset($_REQUEST['estatus'])) || isset($_FILES['foto'])){
                ...
                if($resultado==1){
                    ...
                    header("Location: ../../frontend/vistas/privado/productos/index_trabajador.php?estatus=actualizado");
                }
            }else{
                header("Location: ../../frontend/vistas/privado/productos/index_trabajador.php?estatus=No_actualizado");
                }  
              break;
        ...
        case 3: //delete
            ...
            if (isset($_REQUEST['id'])) {
                ...
                if($resultado == 1){
                    ...
                    header("Location: ../../frontend/vistas/privado/productos/index_trabajador.php?estatus=borrado");
                }else{
                   // header("Location: ../../frontend/vistas/clientes/index.php?estatus=NoBorrado");
                   header("Location: ../../frontend/vistas/privado/productos/index_trabajador.php?estatus=No_borrado");
