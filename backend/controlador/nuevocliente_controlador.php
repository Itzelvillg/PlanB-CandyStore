        ...
        case 1: //create
            if(isset($_REQUEST['id']) && isset($_REQUEST['nombre']) && isset($_REQUEST['apellido']) && isset($_REQUEST['direccion']) && isset($_REQUEST['telefono']) && isset($_FILES['foto']) &&  isset($_REQUEST['email']) && isset($_REQUEST['pass'])){
                ...
                if($resultado == 1){
                   ...
                   header("Location: ../../frontend/vistas/privado/sing-in/index.php?estatus=Registrado");

                }else{
                   header("Location: ../../frontend/vistas/privado/sing-in/index.php?estatus=No_registrado");
